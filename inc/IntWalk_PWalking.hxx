...
//! This class implements an algorithm to determine the <br>
//!          intersection between 2 parametrized surfaces, marching from <br>
//!          a starting point. The intersection line <br>
//!          starts and ends on the natural surface's  boundaries . <br>
class IntWalk_PWalking  {
public:

  DEFINE_STANDARD_ALLOC

  //! Constructor used to set the data to compute intersection <br>
//!          lines between Caro1 and Caro2. <br>
//!          Deflection is the maximum deflection admitted between two <br>
//!          consecutive points on the resulting polyline. <br>
//!          TolTangency is the tolerance to find a tangent point. <br>
//!          Func is the criterion which has to be evaluated at each <br>
//!          solution point (each point of the line). <br>
//!          It is necessary to call the Perform method to compute <br>
//!          the intersection lines. <br>
//!          The line found starts at a point on or in 2 natural domains <br>
//!          of surfaces. It can be closed in the <br>
//!          standard case if it is open it stops and begins at the <br>
//!          border of one of the domains. If an open line <br>
//!          stops at the middle of a domain, one stops at the tangent point. <br>
//!          Epsilon is SquareTolerance of points confusion. <br>
  ...
  //! Returns the intersection line containing the exact <br>
//!          point Poin. This line is a polygonal line. <br>
//!          Deflection is the maximum deflection admitted between two <br>
//!          consecutive points on the resulting polyline. <br>
//!          TolTangency is the tolerance to find a tangent point. <br>
//!          Func is the criterion which has to be evaluated at each <br>
...
//!          Epsilon is SquareTolerance of points confusion. <br>
  ...
  //! calculate the line of intersection <br>
  Standard_EXPORT     void Perform(const TColStd_Array1OfReal& ParDep) ;
  //! calculate the line of intersection. The regulation <br>
//!          of steps is done using min and max values on u and <br>
//!          v.  (if this data is not presented as in the <br>
//!          previous method, the initial steps are calculated <br>
//!          starting from min and max uv of faces). <br>
  ...
  //! calculate the first point of a line of intersection <br>
//! <br>
  ...
  //! Returns the number of points of the resulting polyline. <br>
//!          An exception is raised if IsDone returns False. <br>
        Standard_Integer NbPoints() const;
  //! Returns the point of range Index on the polyline. <br>
//!          An exception is raised if IsDone returns False. <br>
//!          An exception is raised if Index<=0 or Index>NbPoints. <br>
  ...
  //! Returns True if the surface are tangent at the first point <br>
//!          of the line. <br>
//!          An exception is raised if IsDone returns False. <br>
        Standard_Boolean TangentAtFirst() const;
  //! Returns true if the surface are tangent at the last point <br>
//!          of the line. <br>
//!          An exception is raised if IsDone returns False. <br>
        Standard_Boolean TangentAtLast() const;
  //! Returns True if the line is closed. <br>
//!          An exception is raised if IsDone returns False. <br>
