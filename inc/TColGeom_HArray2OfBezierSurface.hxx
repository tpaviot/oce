...
public:
      ...
      TColGeom_HArray2OfBezierSurface(const Standard_Integer R1,const Standard_Integer R2,const Standard_Integer C1,const Standard_Integer C2,const Handle(Geom_BezierSurface)& V);
  
        void Init(const Handle(Geom_BezierSurface)& V) ;
