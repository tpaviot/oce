...
//!          Shell or Solid from TopoDS and ManifoldSolidBrep from <br>
...
public:
  ...
  Standard_EXPORT    const Handle_StepShape_ManifoldSolidBrep& Value() const;
...
Handle_StepShape_ManifoldSolidBrep theManifoldSolidBrep;
