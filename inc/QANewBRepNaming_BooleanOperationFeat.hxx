...
//! To load the BooleanOperationFeat results <br>
...
public:
  ...
  //! Returns the label to insert modified faces of an Object. <br>
  Standard_EXPORT     TDF_Label ModifiedFaces() const;
  //! Returns the label to insert modified edges of an Object. <br>
  Standard_EXPORT     TDF_Label ModifiedEdges() const;
  //! Returns the label to insert deleted faces of an Object. <br>
  Standard_EXPORT     TDF_Label DeletedFaces() const;
  //! Returns the label to insert deleted edges of an Object. <br>
  Standard_EXPORT     TDF_Label DeletedEdges() const;
  //! Returns the label to insert deleted vertices of an Object. <br>
  Standard_EXPORT     TDF_Label DeletedVertices() const;
  //! Returns the label to insert added shapes to an Object <br>
//! (given from tool). <br>
...
//!          returns the underlying shape type. <br>
  ...
  //! Returns true if workaround case identified <br>
...
//!          a boolean operation. <br>
  ...
  //! To process special cases with evolution 1 to n <br>
  ...
  //! To process special cases with evolution 1 to 1 <br>
  ...
  //! To process special case when result has symmetrical edges <br>
