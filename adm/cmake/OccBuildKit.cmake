...
FOREACH(MODULE ${TOOLKIT_MODULES})
	...
	SET(TARGET_INCLUDE_DIRECTORIES 
		"${TARGET_INCLUDE_DIRECTORIES} -I${OpenCASCADE_SOURCE_DIR}/src/${MODULE} -I${OpenCASCADE_SOURCE_DIR}/drv/${MODULE} -I${OpenCASCADE_SOURCE_DIR}/inc ")
...
SET_TARGET_PROPERTIES(${TOOLKIT} PROPERTIES
	...
	VERSION ${OpenCASCADE_VERSION_MAJOR}.${OpenCASCADE_VERSION_MINOR}.${OpenCASCADE_VERSION_PATCH}
)
...
LIST(APPEND INSTALL_HEADERS ${OpenCASCADE_BINARY_DIR}/inc/config.h)
