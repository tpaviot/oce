...
IMPLEMENT_STANDARD_TYPE(TColGeom2d_HArray1OfGeometry)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(TColGeom2d_HArray1OfGeometry)


IMPLEMENT_DOWNCAST(TColGeom2d_HArray1OfGeometry,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(TColGeom2d_HArray1OfGeometry)
