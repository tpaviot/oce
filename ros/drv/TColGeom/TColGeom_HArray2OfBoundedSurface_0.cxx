...
IMPLEMENT_STANDARD_TYPE(TColGeom_HArray2OfBoundedSurface)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(TColGeom_HArray2OfBoundedSurface)


IMPLEMENT_DOWNCAST(TColGeom_HArray2OfBoundedSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(TColGeom_HArray2OfBoundedSurface)
