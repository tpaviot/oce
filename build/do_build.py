...
override_envvar(
    "CFLAGS",
    "-O2 -ftree-vectorize -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   -m64 -march=x86-64-v2 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection",
)
override_envvar(
    "CXXFLAGS",
    "-O2 -ftree-vectorize -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   -m64 -march=x86-64-v2 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection",
...
override_envvar(
    "FFLAGS",
    "-O2 -ftree-vectorize -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   -m64 -march=x86-64-v2 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection -I/usr/lib64/gfortran/modules",
)
override_envvar(
    "FCFLAGS",
    "-O2 -ftree-vectorize -flto=auto -ffat-lto-objects -fexceptions -g -grecord-gcc-switches -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fstack-protector-strong  -m64 -march=x86-64-v2 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection -I/usr/lib64/gfortran/modules",
...
override_envvar(
    "LDFLAGS",
    "-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now   -Wl,--build-id=sha1 -Wl,-dT",
)
...
cmds = [
    f"""/usr/bin/cmake -S . -B amazon-linux-build -DCMAKE_C_FLAGS_RELEASE:STRING=-DNDEBUG -DCMAKE_CXX_FLAGS_RELEASE:STRING=-DNDEBUG -DCMAKE_Fortran_FLAGS_RELEASE:STRING=-DNDEBUG -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DCMAKE_INSTALL_DO_STRIP:BOOL=OFF -DCMAKE_INSTALL_PREFIX:PATH=/usr -DINCLUDE_INSTALL_DIR:PATH=/usr/include -DLIB_INSTALL_DIR:PATH=/usr/lib64 -DSYSCONF_INSTALL_DIR:PATH=/etc -DSHARE_INSTALL_PREFIX:PATH=/usr/share -DLIB_SUFFIX=64 -DBUILD_SHARED_LIBS:BOOL=ON -GNinja -DINSTALL_DIR_LIB=lib64 -DINSTALL_DIR_CMAKE=lib64/cmake/oce-7.4 -DINSTALL_DIR_DATA=share/oce-7.4/data -DINSTALL_DIR_RESOURCE=share/oce-7.4/resources -DINSTALL_DIR_DOC=share/doc/oce-7.4 -DINSTALL_DIR_INCLUDE=local/include/opencascade -DINSTALL_DIR_RESOURCE=share/oce-7.4/resources -DINSTALL_DIR_SAMPLES=share/oce-7.4/samples -DINSTALL_DIR_TESTS=share/oce-7.4/tests -DBUILD_MODULE_Draw=OFF ../""",
    f"""/usr/bin/cmake --build amazon-linux-build -j2 --verbose""",
    f"""/usr/bin/cmake --install amazon-linux-build""",
]
