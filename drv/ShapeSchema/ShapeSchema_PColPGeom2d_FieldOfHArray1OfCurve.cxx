...
#endif
#include <ShapeSchema_PColPGeom2d_FieldOfHArray1OfCurve.ixx>
...
void ShapeSchema_PColPGeom2d_FieldOfHArray1OfCurve::SAdd(const PColPGeom2d_FieldOfHArray1OfCurve& p, const Handle(Storage_Schema)& theSchema)
{
    Standard_Integer i;
